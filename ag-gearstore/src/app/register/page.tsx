...
/**
 * Modern minimalist register page with animations
 */
          ...
          <CardHeader className="text-center space-y-2 pb-8">
            ...
            >
              <CardTitle className="text-3xl font-light text-gray-900 dark:text-gray-100 tracking-tight">
                Join <span className="text-blue-950 dark:text-amber-500">AG's GearStore</span>
              </CardTitle>
            </motion.div>
            <motion.div
              initial={{ opacity: 0 }}
            ...
            >
              <CardDescription className="text-gray-600 dark:text-gray-400">
                Create an account for exclusive perks and loyalty rewards
              </CardDescription>
            </motion.div>
          </CardHeader>
